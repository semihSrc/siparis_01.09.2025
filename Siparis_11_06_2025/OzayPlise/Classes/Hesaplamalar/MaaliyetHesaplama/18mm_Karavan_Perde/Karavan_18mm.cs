...
{
    internal class Karavan_18mm
    {
        public string product_type = "18mm_karavan";
        public string Name { get; set; } = "18mm Karavan Perde Maaliyet Hesaplama";

        public string settings_name = "karavan_18mm_";
        public DataTable Hesapla(double en, double boy)
        {
            DataTable dikey = (new _18mm_Karavan_Perde_Dikey()).Hesapla(en, boy);
            DataTable yatay = (new _18mm_Karavan_Perde_Yatay()).Hesapla(en, boy);
            DataTable ort = (new _18mm_Karavan_Perde_Ort()).Hesapla(en, boy);
