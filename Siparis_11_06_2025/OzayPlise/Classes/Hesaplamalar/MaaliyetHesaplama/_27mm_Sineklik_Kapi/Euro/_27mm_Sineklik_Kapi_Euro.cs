...
{
    internal class _27mm_Sineklik_Kapi_Euro
    {
        public string product_type = "27mm_euro";
        public string Name = "27mm Sineklik Kapı Euro Maaliyet Hesaplama";
        public string settings_name = "sk27mm_";
        public DataTable Hesapla(double en, double boy)
        {
            DataTable dikey = (new _27mm_Dikey_Sineklik_Kapi_Euro()).Hesapla(en, boy);
            DataTable yatay = (new _27mm_Yatay_Sineklik_Kapi_Euro()).Hesapla(en, boy);
            DataTable ort = (new _27mm_Ort_Sineklik_Kapi_Euro()).Hesapla(en, boy);
